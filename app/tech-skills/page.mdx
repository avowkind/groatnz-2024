export const metadata = {
  ...
  description: "Comprehensive technical skills of Andrew Watkins including Python, JavaScript/TypeScript, React, Next.js, AI/ML tools, AWS, serverless architecture, mobile development, and more.",
  keywords: [
    "Python",
    "JavaScript",
    "TypeScript",
  ...
  openGraph: {
    ...
    description: "Comprehensive technical skills including Python, JavaScript/TypeScript, React, Next.js, AI/ML tools, AWS, and serverless architecture.",
    url: "/tech-skills",
  },
};
