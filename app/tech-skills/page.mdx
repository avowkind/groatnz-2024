...
- AWS core services: EC2, S3, IAM, ECR, ECS, SQS, SNS
- AWS APIGateway, Lambda (Python/JS/Java)
- Cloudwatch: Dashboard, Metrics, Trace, Alarms, Notifications
- Infrastructure build: CloudFormation/CDK, 
