export const metadata = {
  title: "Resume",
  description: "Detailed resume and employment history of Andrew Watkins, Software Engineer with 40+ years of experience. Includes roles at PixelFusion, Plant and Food Research, Voluntarily.nz, NIWA, and more.",
  openGraph: {
    title: "Andrew Watkins - Resume",
    description: "Detailed resume and employment history of Andrew Watkins, Software Engineer with 40+ years of experience.",
    url: "/resume",
  },
};
...
-   Full stack web development: HTML, CSS, React, NextJS, MERN (Mongo, Express,
    React, Node)
...
Projects:
-   July 2025 -- Present - Nexties - LivenLabs
    ([https://github.com/LivenLabs/nexties](https://github.com/LivenLabs/nexties)) (Next.js, TypeScript, React, GraphQL, Laravel, AWS Lambda, CDK, Braintrust)

    -   Full-stack development on AI-first education technology platform
    -   Designed and implemented course harvester AI web scraping pipeline using Firecrawl
    -   Integrated Braintrust for production LLM prompt management, logging, monitoring
    -   43+ merged PRs across frontend, backend, infrastructure
    -   Security hardening: PII redaction from CloudWatch logs and GraphQL queries
    -   Architected provider/campus system: 6,382+ lines, GraphQL schema, Nova admin
    -   Fixed CI/CD failures: Docker → esbuild migration
    -   Bot traffic mitigation: Vercel Edge middleware
    -   Next.js, TypeScript, React, GraphQL, Laravel/Nova, AWS Lambda, CDK, Braintrust, Vercel Edge

-   March 2025 -- June 2025 - Intellihub
    ...
    -   Significant cost reduction through serverless architecture
...
-   October 2023 -- November 2025 - The Energy Collective (TEC)
...
-   2025 - Edelman Fossil Park
    (Sanity CMS, Next.js, React, TypeScript)

    -   Took over development of museum website project using Sanity headless CMS
    -   Brought the product to production
    -   Completed Sanity CMS integration and configuration
    -   Implemented responsive design and content management capabilities
...
## Founder & Developer: groat.nz

March 2025 -- Present (Personal Project)

Personal commercial project: iOS application for Hyperbaric Oxygen Therapy (HBOT) session tracking using iPhone barometric sensors.

Projects:

-   March 2025 -- Present - DeepAura iOS App
    ([https://github.com/avowkind/deepaura](https://github.com/avowkind/deepaura)) (React Native, Expo, TypeScript, Firebase, HealthKit)

    -   iOS application for automated Hyperbaric Oxygen Therapy (HBOT) session tracking
    -   Uses iPhone's built-in barometric sensor to automatically detect and track HBOT sessions
    -   Real-time pressure monitoring, safety alerts for rapid decompression
    -   Apple HealthKit integration for vital signs monitoring
    -   Camera-based heart rate monitoring using photoplethysmography (PPG)
    -   Firebase backend integration (Auth, Firestore, Storage)
    -   Offline-first architecture with SQLite local storage
    -   Background task processing for continuous monitoring
    -   React Native, Expo, TypeScript, Firebase, HealthKit, SQLite, Expo Sensors, React Native Vision Camera

-   March 2025 -- Present - DeepAura Web
    (Next.js, React, TypeScript, Sanity CMS, Cloudflare Workers)

    -   Marketing website and content management system
    -   Next.js website with Sanity headless CMS
